...
SECRET_KEY = os.getenv("SECRET_KEY", "django-insecure-openmedailab-dev-key")
...
WHITENOISE_MANIFEST_STRICT = os.getenv("WHITENOISE_MANIFEST_STRICT", "0" if DEBUG else "1").lower() in {"1", "true", "yes", "on"}
