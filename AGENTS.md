...
- 课题标题进入 `#/project/{id}` 独立进度页，详情页具备首页同等核心协作 CTA；主 PDF 仍通过单独查看/下载入口打开。
...
- 积分自动运营规则属于主流程：注册初始积分按身份发放（医生 250 分、博士在读/博士毕业及以上 200 分、学生及其他身份 100 分）；首次完善资料奖励 5 分；项目启动扣除每名参与人 50 分；进行中课题归档视为结题，返还每名参与人 100 分；用户可单次最多转赠 50 分。
...
- 积分主规则：注册初始积分按身份发放，医生 250 分、博士在读/博士毕业及以上 200 分、学生及其他身份 100 分；首次完善资料 +5；项目启动扣除每名参与人 50；进行中课题归档返还每名参与人 100；单次转赠上限 50。
